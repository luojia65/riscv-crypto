...
standard), it marks this sample passed this test. If the samples would pass
all the test methods, it passes randomness requirement of this standard.
...
transform test. Parameters of these methods are defined in Appendix B of the
standard.
